...
from corpus_util import Nlp4plpCorpus, Nlp4plpEncoder, Nlp4plpEncDecEncoder
...
def main():
    ...
    print('Saving...')
    save_preds_encdec_pl(dev_corp,
                         _y_true_dev,
                         _y_pred_dev,
                         classifier.f_model,
                         label_vocab=corpus_encoder.label_vocab,
                         beam_decoding=args.beam_decoding,
                         dir_out='/home/fivez/math_problems/model_outputs/dev/')
    ...
    print('Saving...')
    save_preds_encdec_pl(train_corp,
                         _y_true_train,
                         _y_pred_train,
                         classifier.f_model,
                         label_vocab=corpus_encoder.label_vocab,
                         beam_decoding=args.beam_decoding,
                         dir_out='/home/fivez/math_problems/model_outputs/train/')
    ...
    save_preds_encdec_pl(test_corp,
                         ...
                         label_vocab=corpus_encoder.label_vocab,
                         beam_decoding=args.beam_decoding,
                         dir_out='/home/fivez/math_problems/model_outputs/test/')


if __name__ == '__main__':
    main()

# PYTHONHASHSEED=0 python3.6 main_results.py --data-dir resources/examples_splits_nums_mapped/ --embed-size 100 --ret-period 30 --feat-type pos rels num --beam-decoding --beam-width 10 --beam-topk 100 --model-path /home/fivez/math_problems/models/20191118_151545_853074  --rank-discrete-feat-type score rank --lr 0.0001

# python3.6 main_results.py --data-dir resources/examples_splits_nums_mapped/ --model lstm-enc-regression-dec --pretrained-emb-path /home/suster/Apps/neural-nlp4plp/resources/embeddings --epochs 30 --n-runs 5 --beam-width 10 --beam-topk 100
